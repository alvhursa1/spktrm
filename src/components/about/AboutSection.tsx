...
const texts = [
  ...
  { id: 4, content: "Providing solid opportunities for talented illustrators and to bridge the gap between their creativity and an international market eager for fresh and authentic voices.", className: "-mt-[8%] text-[1rem] font-satoshi pl-[50%]" },
]
